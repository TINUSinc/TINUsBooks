...
<body>
    <div class="containerTransparente">
        <img src="../../media/nosotros/Historia.jpg" id="imgConocenos" alt="Conócenos">
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text">Tengo 20 años, me gusta ir al gimnasio. Me considero una
                            persona muy artística pues me gusta tocar el piano y pintar</p>
                        <p class="card-text"><small class="text-muted"><a href="https://www.facebook.com/ffabiolad"
                                    target="_blank"><i class="fa-brands fa-square-facebook fa-2x"
                                        style="color: white"></i></a><a href="https://www.facebook.com/ffabiolad"
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text">Soy un fifas, le voy al Amierdica pero acepto que el mejor
                            equipo es el Necaxa, Fuerza Rayos. Yo hice el captcha y me quedo genial</p>
                        <p class="card-text"><small class="text-muted"><a href="https://www.facebook.com/emunozce.6"
                                    target="_blank"><i class="fa-brands fa-square-facebook fa-2x"
                                        style="color: white"></i></a><a href="https://www.instagram.com/mannymunoz_/"
                                    target="_blank"><i style="padding-left:5px;color:white;"
                                        class="fa-brands fa-square-instagram fa-2x"
                                        style="color: white"></i></a></small></p>
                        <hr>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><small class="text-muted"><a
                                    href="https://www.facebook.com/franciscodejesus.mendezlara" target="_blank"><i
                                        class="fa-brands fa-square-facebook fa-2x" style="color: white"></i></a><a
                                    href="https://www.instagram.com/franciscomendez324/" target="_blank"><i
                                        style="padding-left:5px;color:white;"
                                        class="fa-brands fa-square-instagram fa-2x"
                                        style="color: white"></i></a></small></p>
                        <hr>
